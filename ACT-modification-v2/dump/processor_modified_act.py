...
"""Processor pipeline for Modified ACT policy."""
...
def make_modified_act_pre_post_processors(
    ...
    """Creates the pre- and post-processing pipelines for the Modified ACT policy.
    ...
    Args:
        config (ModifiedACTConfig): The Modified ACT policy configuration object.
